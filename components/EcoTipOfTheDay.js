...
const ecoTips = [
  ...
  {
    tip: "Use reusable bags, bottles, and containers to reduce single-use items.",
    category: "Reusability",
    emoji: "👜"
  },
  {
    tip: "Choose LED bulbs - they use 75% less energy than incandescent bulbs.",
    category: "Lighting",
    emoji: "💡"
  },
  {
    tip: "Repair and repurpose items instead of throwing them away.",
    category: "Repair",
    emoji: "🔧"
  },
  {
    tip: "Choose products with minimal water usage in production and use.",
    category: "Water",
    emoji: "💧"
  },
  {
    tip: "Support companies with transparent sustainability reporting.",
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -50 }}
        className="eco-card p-4 mb-6 max-w-2xl mx-auto bg-gradient-to-r from-green-50 to-blue-50 border-green-200"
      >
